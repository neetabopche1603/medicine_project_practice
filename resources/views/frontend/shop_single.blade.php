...
<div class="bg-light py-3">
  <div class="container">
    <div class="row">
      <div class="col-md-12 mb-0"><a href="{{route('frontend.index')}}">Home</a> <span class="mx-2 mb-0">/</span> <a
          href="{{route('frontend.shop')}}">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Ibuprofen Tablets, 200mg</strong></div>
    </div>
  </div>
</div>
    ...
    <div class="row">
      <div class="col-md-5 mr-auto">
        <div class="border text-center">
          <img src="{{asset('frontend/images/product_07_large.png')}}" alt="Image" class="img-fluid p-5">
        </div>
      </div>
      <div class="col-md-6">
        ...
        <p><a href="{{route('frontend.cart')}}" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary">Add To Cart</a></p>
